...
On macOS and Linux, this is typically: **~/Repos**.

The **Repos** folder should be directly inside your home directory and
must **NOT** be inside a cloud-synced location such as iCloud Desktop,
Documents, OneDrive, Dropbox, or similar services.
...
Follow the Mac/Linux instructions in:
