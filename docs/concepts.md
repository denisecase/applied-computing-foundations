...
An operating system is software that provides a computer's core functions,
including managing hardware, files, and applications.

### System files

System files are files required by the operating system and are not intended
...
Linux is an open-source operating system commonly used on servers and
development systems.

### Administrator

An administrator is a user account with elevated permissions to create,
delete, or modify system settings and files.

## Command Line

The command line provides a text-based way to work with the computer and
development tools.
...
A folder, also called a directory, is a container used to organize files on
a computer.
...
The current folder, also called the working directory, is the folder the
terminal is "in" right now.
...
User interfaces provide different ways to interact with files, applications,
and operating-system features.

### Context menu

A context menu is a menu that appears when right-clicking, or control-clicking,
an item.

### Windows File Explorer

Windows File Explorer is the graphical interface used to browse files and
folders on Windows.
...
Version control records project history so work can be saved, shared, and
updated over time.
...
A repository, often called a repo, is a folder that Git tracks, including its
history.
